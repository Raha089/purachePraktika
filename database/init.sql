...
('CUST001', 'ООО "Ромашка"', '1234567890', true),
('CUST002', 'Иванов Иван Иванович', '123456789012', false);

INSERT INTO purchase.lot (lot_name, customer_code, price, currency_code, nds_rate, place_delivery, date_delivery) VALUES
('Ноутбуки Dell', 'CUST001', 150000.00, 'RUB', '20%', 'Москва, ул. Пушкина 1', '2024-12-31 18:00:00'),
('Офисные стулья', 'CUST001', 25000.50, 'RUB', '20%', 'Санкт-Петербург, Невский пр. 10', '2024-11-30 10:00:00');
